...
class Question:
    ...
    def get_res(self):
        if len(self.options) == 0:
            ...
            print('nnnn'+str(self.most_common_answer)+'nnnn')
    ...
    for row, r in enumerate(answers.find()):
        ...
        try:
            ...
            for field in ['surname', 'name', 'patronymic', 'class', 'type', 'variant']:
                question = Question(field, most_common_answer=answers_by_checks[field][0], yellow=yellow, red=red)
                for personal in r['personal'][1:]: # first element is generated by default
